-- Lifeless profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Lifeless' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Lifeless.LifelessGameStateInGame:BroadcastChatMessage",
            "/Script/Lifeless.LifelessGameState:BroadcastChatMessage",
            "/Script/Lifeless.LifelessGameState:Multicast_ChatMessage",
            "/Script/Lifeless.LifelessPlayerController:ClientReceiveChatMessage",
            "/Script/Lifeless.LifelessPlayerController:ServerSendChatMessage",
            "/Script/Lifeless.LifelessGameMode:ReceiveChatMessage",
            "/Script/Lifeless.LifelessPlayerController:ServerSay",
            "/Script/Lifeless.LifelessPlayerController:ClientMessage"
        },
