-- BATTALION: Legacy profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'BattalionLegacy' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/BattalionLegacy.BattalionLegacyGameStateInGame:BroadcastChatMessage",
            "/Script/BattalionLegacy.BattalionLegacyGameState:BroadcastChatMessage",
            "/Script/BattalionLegacy.BattalionLegacyGameState:Multicast_ChatMessage",
            "/Script/BattalionLegacy.BattalionLegacyPlayerController:ClientReceiveChatMessage",
            "/Script/BattalionLegacy.BattalionLegacyPlayerController:ServerSendChatMessage",
            "/Script/BattalionLegacy.BattalionLegacyGameMode:ReceiveChatMessage",
            "/Script/BattalionLegacy.BattalionLegacyPlayerController:ServerSay",
            "/Script/BattalionLegacy.BattalionLegacyPlayerController:ClientMessage"
        },
