-- Draconia profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Draconia' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Draconia.DraconiaGameStateInGame:BroadcastChatMessage",
            "/Script/Draconia.DraconiaGameState:BroadcastChatMessage",
            "/Script/Draconia.DraconiaGameState:Multicast_ChatMessage",
            "/Script/Draconia.DraconiaPlayerController:ClientReceiveChatMessage",
            "/Script/Draconia.DraconiaPlayerController:ServerSendChatMessage",
            "/Script/Draconia.DraconiaGameMode:ReceiveChatMessage",
            "/Script/Draconia.DraconiaPlayerController:ServerSay",
            "/Script/Draconia.DraconiaPlayerController:ClientMessage"
        },
