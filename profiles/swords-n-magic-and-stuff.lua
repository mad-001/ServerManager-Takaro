-- Swords 'n Magic and Stuff profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'SwordsNMagicAndStuff' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/SwordsNMagicAndStuff.SwordsNMagicAndStuffGameStateInGame:BroadcastChatMessage",
            "/Script/SwordsNMagicAndStuff.SwordsNMagicAndStuffGameState:BroadcastChatMessage",
            "/Script/SwordsNMagicAndStuff.SwordsNMagicAndStuffGameState:Multicast_ChatMessage",
            "/Script/SwordsNMagicAndStuff.SwordsNMagicAndStuffPlayerController:ClientReceiveChatMessage",
            "/Script/SwordsNMagicAndStuff.SwordsNMagicAndStuffPlayerController:ServerSendChatMessage",
            "/Script/SwordsNMagicAndStuff.SwordsNMagicAndStuffGameMode:ReceiveChatMessage",
            "/Script/SwordsNMagicAndStuff.SwordsNMagicAndStuffPlayerController:ServerSay",
            "/Script/SwordsNMagicAndStuff.SwordsNMagicAndStuffPlayerController:ClientMessage"
        },
