-- Conan Exiles profile for ServerManager-Takaro
-- Engine: ue5. Confidence: medium (known /Script module).
...
--   (Objects dumper) and set an explicit chat.hook. Module 'Game' is the game's real /Script module.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Game.GameGameStateInGame:BroadcastChatMessage",
            "/Script/Game.GameGameState:BroadcastChatMessage",
            "/Script/Game.GameGameState:Multicast_ChatMessage",
            "/Script/Game.GamePlayerController:ClientReceiveChatMessage",
            "/Script/Game.GamePlayerController:ServerSendChatMessage",
            "/Script/Game.GameGameMode:ReceiveChatMessage",
            "/Script/Game.GamePlayerController:ServerSay",
            "/Script/Game.GamePlayerController:ClientMessage"
        },
