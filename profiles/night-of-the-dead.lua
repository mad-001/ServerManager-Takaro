-- Night of the Dead profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'NightOfTheDead' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/NightOfTheDead.NightOfTheDeadGameStateInGame:BroadcastChatMessage",
            "/Script/NightOfTheDead.NightOfTheDeadGameState:BroadcastChatMessage",
            "/Script/NightOfTheDead.NightOfTheDeadGameState:Multicast_ChatMessage",
            "/Script/NightOfTheDead.NightOfTheDeadPlayerController:ClientReceiveChatMessage",
            "/Script/NightOfTheDead.NightOfTheDeadPlayerController:ServerSendChatMessage",
            "/Script/NightOfTheDead.NightOfTheDeadGameMode:ReceiveChatMessage",
            "/Script/NightOfTheDead.NightOfTheDeadPlayerController:ServerSay",
            "/Script/NightOfTheDead.NightOfTheDeadPlayerController:ClientMessage"
        },
