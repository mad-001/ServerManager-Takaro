-- '83 profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as '83' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/83.83GameStateInGame:BroadcastChatMessage",
            "/Script/83.83GameState:BroadcastChatMessage",
            "/Script/83.83GameState:Multicast_ChatMessage",
            "/Script/83.83PlayerController:ClientReceiveChatMessage",
            "/Script/83.83PlayerController:ServerSendChatMessage",
            "/Script/83.83GameMode:ReceiveChatMessage",
            "/Script/83.83PlayerController:ServerSay",
            "/Script/83.83PlayerController:ClientMessage"
        },
