-- Hatred profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Hatred' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Hatred.HatredGameStateInGame:BroadcastChatMessage",
            "/Script/Hatred.HatredGameState:BroadcastChatMessage",
            "/Script/Hatred.HatredGameState:Multicast_ChatMessage",
            "/Script/Hatred.HatredPlayerController:ClientReceiveChatMessage",
            "/Script/Hatred.HatredPlayerController:ServerSendChatMessage",
            "/Script/Hatred.HatredGameMode:ReceiveChatMessage",
            "/Script/Hatred.HatredPlayerController:ServerSay",
            "/Script/Hatred.HatredPlayerController:ClientMessage"
        },
