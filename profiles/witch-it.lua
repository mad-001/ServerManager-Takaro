-- Witch It profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'WitchIt' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/WitchIt.WitchItGameStateInGame:BroadcastChatMessage",
            "/Script/WitchIt.WitchItGameState:BroadcastChatMessage",
            "/Script/WitchIt.WitchItGameState:Multicast_ChatMessage",
            "/Script/WitchIt.WitchItPlayerController:ClientReceiveChatMessage",
            "/Script/WitchIt.WitchItPlayerController:ServerSendChatMessage",
            "/Script/WitchIt.WitchItGameMode:ReceiveChatMessage",
            "/Script/WitchIt.WitchItPlayerController:ServerSay",
            "/Script/WitchIt.WitchItPlayerController:ClientMessage"
        },
