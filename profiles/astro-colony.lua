-- Astro Colony profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'AstroColony' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/AstroColony.AstroColonyGameStateInGame:BroadcastChatMessage",
            "/Script/AstroColony.AstroColonyGameState:BroadcastChatMessage",
            "/Script/AstroColony.AstroColonyGameState:Multicast_ChatMessage",
            "/Script/AstroColony.AstroColonyPlayerController:ClientReceiveChatMessage",
            "/Script/AstroColony.AstroColonyPlayerController:ServerSendChatMessage",
            "/Script/AstroColony.AstroColonyGameMode:ReceiveChatMessage",
            "/Script/AstroColony.AstroColonyPlayerController:ServerSay",
            "/Script/AstroColony.AstroColonyPlayerController:ClientMessage"
        },
