-- Neptune: Arena FPS profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'NeptuneArenaFps' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/NeptuneArenaFps.NeptuneArenaFpsGameStateInGame:BroadcastChatMessage",
            "/Script/NeptuneArenaFps.NeptuneArenaFpsGameState:BroadcastChatMessage",
            "/Script/NeptuneArenaFps.NeptuneArenaFpsGameState:Multicast_ChatMessage",
            "/Script/NeptuneArenaFps.NeptuneArenaFpsPlayerController:ClientReceiveChatMessage",
            "/Script/NeptuneArenaFps.NeptuneArenaFpsPlayerController:ServerSendChatMessage",
            "/Script/NeptuneArenaFps.NeptuneArenaFpsGameMode:ReceiveChatMessage",
            "/Script/NeptuneArenaFps.NeptuneArenaFpsPlayerController:ServerSay",
            "/Script/NeptuneArenaFps.NeptuneArenaFpsPlayerController:ClientMessage"
        },
