-- Fractured Space profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'FracturedSpace' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/FracturedSpace.FracturedSpaceGameStateInGame:BroadcastChatMessage",
            "/Script/FracturedSpace.FracturedSpaceGameState:BroadcastChatMessage",
            "/Script/FracturedSpace.FracturedSpaceGameState:Multicast_ChatMessage",
            "/Script/FracturedSpace.FracturedSpacePlayerController:ClientReceiveChatMessage",
            "/Script/FracturedSpace.FracturedSpacePlayerController:ServerSendChatMessage",
            "/Script/FracturedSpace.FracturedSpaceGameMode:ReceiveChatMessage",
            "/Script/FracturedSpace.FracturedSpacePlayerController:ServerSay",
            "/Script/FracturedSpace.FracturedSpacePlayerController:ClientMessage"
        },
