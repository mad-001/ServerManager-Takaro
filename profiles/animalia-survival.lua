-- Animalia Survival profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'AnimaliaSurvival' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/AnimaliaSurvival.AnimaliaSurvivalGameStateInGame:BroadcastChatMessage",
            "/Script/AnimaliaSurvival.AnimaliaSurvivalGameState:BroadcastChatMessage",
            "/Script/AnimaliaSurvival.AnimaliaSurvivalGameState:Multicast_ChatMessage",
            "/Script/AnimaliaSurvival.AnimaliaSurvivalPlayerController:ClientReceiveChatMessage",
            "/Script/AnimaliaSurvival.AnimaliaSurvivalPlayerController:ServerSendChatMessage",
            "/Script/AnimaliaSurvival.AnimaliaSurvivalGameMode:ReceiveChatMessage",
            "/Script/AnimaliaSurvival.AnimaliaSurvivalPlayerController:ServerSay",
            "/Script/AnimaliaSurvival.AnimaliaSurvivalPlayerController:ClientMessage"
        },
