-- Athos profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Athos' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Athos.AthosGameStateInGame:BroadcastChatMessage",
            "/Script/Athos.AthosGameState:BroadcastChatMessage",
            "/Script/Athos.AthosGameState:Multicast_ChatMessage",
            "/Script/Athos.AthosPlayerController:ClientReceiveChatMessage",
            "/Script/Athos.AthosPlayerController:ServerSendChatMessage",
            "/Script/Athos.AthosGameMode:ReceiveChatMessage",
            "/Script/Athos.AthosPlayerController:ServerSay",
            "/Script/Athos.AthosPlayerController:ClientMessage"
        },
