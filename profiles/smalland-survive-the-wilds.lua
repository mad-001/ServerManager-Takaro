-- Smalland: Survive the Wilds profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'SmallandSurviveTheWilds' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/SmallandSurviveTheWilds.SmallandSurviveTheWildsGameStateInGame:BroadcastChatMessage",
            "/Script/SmallandSurviveTheWilds.SmallandSurviveTheWildsGameState:BroadcastChatMessage",
            "/Script/SmallandSurviveTheWilds.SmallandSurviveTheWildsGameState:Multicast_ChatMessage",
            "/Script/SmallandSurviveTheWilds.SmallandSurviveTheWildsPlayerController:ClientReceiveChatMessage",
            "/Script/SmallandSurviveTheWilds.SmallandSurviveTheWildsPlayerController:ServerSendChatMessage",
            "/Script/SmallandSurviveTheWilds.SmallandSurviveTheWildsGameMode:ReceiveChatMessage",
            "/Script/SmallandSurviveTheWilds.SmallandSurviveTheWildsPlayerController:ServerSay",
            "/Script/SmallandSurviveTheWilds.SmallandSurviveTheWildsPlayerController:ClientMessage"
        },
