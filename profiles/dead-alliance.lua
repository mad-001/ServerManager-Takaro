-- Dead Alliance profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'DeadAlliance' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/DeadAlliance.DeadAllianceGameStateInGame:BroadcastChatMessage",
            "/Script/DeadAlliance.DeadAllianceGameState:BroadcastChatMessage",
            "/Script/DeadAlliance.DeadAllianceGameState:Multicast_ChatMessage",
            "/Script/DeadAlliance.DeadAlliancePlayerController:ClientReceiveChatMessage",
            "/Script/DeadAlliance.DeadAlliancePlayerController:ServerSendChatMessage",
            "/Script/DeadAlliance.DeadAllianceGameMode:ReceiveChatMessage",
            "/Script/DeadAlliance.DeadAlliancePlayerController:ServerSay",
            "/Script/DeadAlliance.DeadAlliancePlayerController:ClientMessage"
        },
