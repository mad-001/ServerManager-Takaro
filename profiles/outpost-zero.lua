-- Outpost Zero profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'OutpostZero' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/OutpostZero.OutpostZeroGameStateInGame:BroadcastChatMessage",
            "/Script/OutpostZero.OutpostZeroGameState:BroadcastChatMessage",
            "/Script/OutpostZero.OutpostZeroGameState:Multicast_ChatMessage",
            "/Script/OutpostZero.OutpostZeroPlayerController:ClientReceiveChatMessage",
            "/Script/OutpostZero.OutpostZeroPlayerController:ServerSendChatMessage",
            "/Script/OutpostZero.OutpostZeroGameMode:ReceiveChatMessage",
            "/Script/OutpostZero.OutpostZeroPlayerController:ServerSay",
            "/Script/OutpostZero.OutpostZeroPlayerController:ClientMessage"
        },
