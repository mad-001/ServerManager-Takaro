-- Onset profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Onset' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Onset.OnsetGameStateInGame:BroadcastChatMessage",
            "/Script/Onset.OnsetGameState:BroadcastChatMessage",
            "/Script/Onset.OnsetGameState:Multicast_ChatMessage",
            "/Script/Onset.OnsetPlayerController:ClientReceiveChatMessage",
            "/Script/Onset.OnsetPlayerController:ServerSendChatMessage",
            "/Script/Onset.OnsetGameMode:ReceiveChatMessage",
            "/Script/Onset.OnsetPlayerController:ServerSay",
            "/Script/Onset.OnsetPlayerController:ClientMessage"
        },
