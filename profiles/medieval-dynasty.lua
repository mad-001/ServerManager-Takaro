-- Medieval Dynasty profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'MedievalDynasty' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/MedievalDynasty.MedievalDynastyGameStateInGame:BroadcastChatMessage",
            "/Script/MedievalDynasty.MedievalDynastyGameState:BroadcastChatMessage",
            "/Script/MedievalDynasty.MedievalDynastyGameState:Multicast_ChatMessage",
            "/Script/MedievalDynasty.MedievalDynastyPlayerController:ClientReceiveChatMessage",
            "/Script/MedievalDynasty.MedievalDynastyPlayerController:ServerSendChatMessage",
            "/Script/MedievalDynasty.MedievalDynastyGameMode:ReceiveChatMessage",
            "/Script/MedievalDynasty.MedievalDynastyPlayerController:ServerSay",
            "/Script/MedievalDynasty.MedievalDynastyPlayerController:ClientMessage"
        },
