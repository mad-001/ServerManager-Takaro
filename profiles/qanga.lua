-- QANGA profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Qanga' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Qanga.QangaGameStateInGame:BroadcastChatMessage",
            "/Script/Qanga.QangaGameState:BroadcastChatMessage",
            "/Script/Qanga.QangaGameState:Multicast_ChatMessage",
            "/Script/Qanga.QangaPlayerController:ClientReceiveChatMessage",
            "/Script/Qanga.QangaPlayerController:ServerSendChatMessage",
            "/Script/Qanga.QangaGameMode:ReceiveChatMessage",
            "/Script/Qanga.QangaPlayerController:ServerSay",
            "/Script/Qanga.QangaPlayerController:ClientMessage"
        },
