-- Tiki Galore profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'TikiGalore' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/TikiGalore.TikiGaloreGameStateInGame:BroadcastChatMessage",
            "/Script/TikiGalore.TikiGaloreGameState:BroadcastChatMessage",
            "/Script/TikiGalore.TikiGaloreGameState:Multicast_ChatMessage",
            "/Script/TikiGalore.TikiGalorePlayerController:ClientReceiveChatMessage",
            "/Script/TikiGalore.TikiGalorePlayerController:ServerSendChatMessage",
            "/Script/TikiGalore.TikiGaloreGameMode:ReceiveChatMessage",
            "/Script/TikiGalore.TikiGalorePlayerController:ServerSay",
            "/Script/TikiGalore.TikiGalorePlayerController:ClientMessage"
        },
