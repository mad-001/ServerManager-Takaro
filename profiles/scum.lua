-- SCUM profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Scum' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Scum.ScumGameStateInGame:BroadcastChatMessage",
            "/Script/Scum.ScumGameState:BroadcastChatMessage",
            "/Script/Scum.ScumGameState:Multicast_ChatMessage",
            "/Script/Scum.ScumPlayerController:ClientReceiveChatMessage",
            "/Script/Scum.ScumPlayerController:ServerSendChatMessage",
            "/Script/Scum.ScumGameMode:ReceiveChatMessage",
            "/Script/Scum.ScumPlayerController:ServerSay",
            "/Script/Scum.ScumPlayerController:ClientMessage"
        },
