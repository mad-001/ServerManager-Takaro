-- Afterinfection profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Afterinfection' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Afterinfection.AfterinfectionGameStateInGame:BroadcastChatMessage",
            "/Script/Afterinfection.AfterinfectionGameState:BroadcastChatMessage",
            "/Script/Afterinfection.AfterinfectionGameState:Multicast_ChatMessage",
            "/Script/Afterinfection.AfterinfectionPlayerController:ClientReceiveChatMessage",
            "/Script/Afterinfection.AfterinfectionPlayerController:ServerSendChatMessage",
            "/Script/Afterinfection.AfterinfectionGameMode:ReceiveChatMessage",
            "/Script/Afterinfection.AfterinfectionPlayerController:ServerSay",
            "/Script/Afterinfection.AfterinfectionPlayerController:ClientMessage"
        },
