-- BULLETGROUNDS profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Bulletgrounds' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Bulletgrounds.BulletgroundsGameStateInGame:BroadcastChatMessage",
            "/Script/Bulletgrounds.BulletgroundsGameState:BroadcastChatMessage",
            "/Script/Bulletgrounds.BulletgroundsGameState:Multicast_ChatMessage",
            "/Script/Bulletgrounds.BulletgroundsPlayerController:ClientReceiveChatMessage",
            "/Script/Bulletgrounds.BulletgroundsPlayerController:ServerSendChatMessage",
            "/Script/Bulletgrounds.BulletgroundsGameMode:ReceiveChatMessage",
            "/Script/Bulletgrounds.BulletgroundsPlayerController:ServerSay",
            "/Script/Bulletgrounds.BulletgroundsPlayerController:ClientMessage"
        },
