-- BattleRush profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Battlerush' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Battlerush.BattlerushGameStateInGame:BroadcastChatMessage",
            "/Script/Battlerush.BattlerushGameState:BroadcastChatMessage",
            "/Script/Battlerush.BattlerushGameState:Multicast_ChatMessage",
            "/Script/Battlerush.BattlerushPlayerController:ClientReceiveChatMessage",
            "/Script/Battlerush.BattlerushPlayerController:ServerSendChatMessage",
            "/Script/Battlerush.BattlerushGameMode:ReceiveChatMessage",
            "/Script/Battlerush.BattlerushPlayerController:ServerSay",
            "/Script/Battlerush.BattlerushPlayerController:ClientMessage"
        },
