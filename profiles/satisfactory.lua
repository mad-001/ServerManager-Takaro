-- Satisfactory profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Satisfactory' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Satisfactory.SatisfactoryGameStateInGame:BroadcastChatMessage",
            "/Script/Satisfactory.SatisfactoryGameState:BroadcastChatMessage",
            "/Script/Satisfactory.SatisfactoryGameState:Multicast_ChatMessage",
            "/Script/Satisfactory.SatisfactoryPlayerController:ClientReceiveChatMessage",
            "/Script/Satisfactory.SatisfactoryPlayerController:ServerSendChatMessage",
            "/Script/Satisfactory.SatisfactoryGameMode:ReceiveChatMessage",
            "/Script/Satisfactory.SatisfactoryPlayerController:ServerSay",
            "/Script/Satisfactory.SatisfactoryPlayerController:ClientMessage"
        },
