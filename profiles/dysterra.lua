-- Dysterra profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Dysterra' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Dysterra.DysterraGameStateInGame:BroadcastChatMessage",
            "/Script/Dysterra.DysterraGameState:BroadcastChatMessage",
            "/Script/Dysterra.DysterraGameState:Multicast_ChatMessage",
            "/Script/Dysterra.DysterraPlayerController:ClientReceiveChatMessage",
            "/Script/Dysterra.DysterraPlayerController:ServerSendChatMessage",
            "/Script/Dysterra.DysterraGameMode:ReceiveChatMessage",
            "/Script/Dysterra.DysterraPlayerController:ServerSay",
            "/Script/Dysterra.DysterraPlayerController:ClientMessage"
        },
