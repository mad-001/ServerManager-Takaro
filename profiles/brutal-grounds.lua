-- Brutal Grounds profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'BrutalGrounds' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/BrutalGrounds.BrutalGroundsGameStateInGame:BroadcastChatMessage",
            "/Script/BrutalGrounds.BrutalGroundsGameState:BroadcastChatMessage",
            "/Script/BrutalGrounds.BrutalGroundsGameState:Multicast_ChatMessage",
            "/Script/BrutalGrounds.BrutalGroundsPlayerController:ClientReceiveChatMessage",
            "/Script/BrutalGrounds.BrutalGroundsPlayerController:ServerSendChatMessage",
            "/Script/BrutalGrounds.BrutalGroundsGameMode:ReceiveChatMessage",
            "/Script/BrutalGrounds.BrutalGroundsPlayerController:ServerSay",
            "/Script/BrutalGrounds.BrutalGroundsPlayerController:ClientMessage"
        },
