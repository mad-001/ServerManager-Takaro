-- Birthright profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Birthright' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Birthright.BirthrightGameStateInGame:BroadcastChatMessage",
            "/Script/Birthright.BirthrightGameState:BroadcastChatMessage",
            "/Script/Birthright.BirthrightGameState:Multicast_ChatMessage",
            "/Script/Birthright.BirthrightPlayerController:ClientReceiveChatMessage",
            "/Script/Birthright.BirthrightPlayerController:ServerSendChatMessage",
            "/Script/Birthright.BirthrightGameMode:ReceiveChatMessage",
            "/Script/Birthright.BirthrightPlayerController:ServerSay",
            "/Script/Birthright.BirthrightPlayerController:ClientMessage"
        },
