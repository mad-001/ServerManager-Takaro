-- Fight or Flight profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'FightOrFlight' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/FightOrFlight.FightOrFlightGameStateInGame:BroadcastChatMessage",
            "/Script/FightOrFlight.FightOrFlightGameState:BroadcastChatMessage",
            "/Script/FightOrFlight.FightOrFlightGameState:Multicast_ChatMessage",
            "/Script/FightOrFlight.FightOrFlightPlayerController:ClientReceiveChatMessage",
            "/Script/FightOrFlight.FightOrFlightPlayerController:ServerSendChatMessage",
            "/Script/FightOrFlight.FightOrFlightGameMode:ReceiveChatMessage",
            "/Script/FightOrFlight.FightOrFlightPlayerController:ServerSay",
            "/Script/FightOrFlight.FightOrFlightPlayerController:ClientMessage"
        },
