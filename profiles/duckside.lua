-- Duckside profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Duckside' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Duckside.DucksideGameStateInGame:BroadcastChatMessage",
            "/Script/Duckside.DucksideGameState:BroadcastChatMessage",
            "/Script/Duckside.DucksideGameState:Multicast_ChatMessage",
            "/Script/Duckside.DucksidePlayerController:ClientReceiveChatMessage",
            "/Script/Duckside.DucksidePlayerController:ServerSendChatMessage",
            "/Script/Duckside.DucksideGameMode:ReceiveChatMessage",
            "/Script/Duckside.DucksidePlayerController:ServerSay",
            "/Script/Duckside.DucksidePlayerController:ClientMessage"
        },
