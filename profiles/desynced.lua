-- Desynced profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Desynced' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Desynced.DesyncedGameStateInGame:BroadcastChatMessage",
            "/Script/Desynced.DesyncedGameState:BroadcastChatMessage",
            "/Script/Desynced.DesyncedGameState:Multicast_ChatMessage",
            "/Script/Desynced.DesyncedPlayerController:ClientReceiveChatMessage",
            "/Script/Desynced.DesyncedPlayerController:ServerSendChatMessage",
            "/Script/Desynced.DesyncedGameMode:ReceiveChatMessage",
            "/Script/Desynced.DesyncedPlayerController:ServerSay",
            "/Script/Desynced.DesyncedPlayerController:ClientMessage"
        },
