...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'ThunderTierOne' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/ThunderTierOne.ThunderTierOneGameStateInGame:BroadcastChatMessage",
            "/Script/ThunderTierOne.ThunderTierOneGameState:BroadcastChatMessage",
            "/Script/ThunderTierOne.ThunderTierOneGameState:Multicast_ChatMessage",
            "/Script/ThunderTierOne.ThunderTierOnePlayerController:ClientReceiveChatMessage",
            "/Script/ThunderTierOne.ThunderTierOnePlayerController:ServerSendChatMessage",
            "/Script/ThunderTierOne.ThunderTierOneGameMode:ReceiveChatMessage",
            "/Script/ThunderTierOne.ThunderTierOnePlayerController:ServerSay",
            "/Script/ThunderTierOne.ThunderTierOnePlayerController:ClientMessage"
        },
