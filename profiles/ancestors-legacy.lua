-- Ancestors Legacy profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'AncestorsLegacy' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/AncestorsLegacy.AncestorsLegacyGameStateInGame:BroadcastChatMessage",
            "/Script/AncestorsLegacy.AncestorsLegacyGameState:BroadcastChatMessage",
            "/Script/AncestorsLegacy.AncestorsLegacyGameState:Multicast_ChatMessage",
            "/Script/AncestorsLegacy.AncestorsLegacyPlayerController:ClientReceiveChatMessage",
            "/Script/AncestorsLegacy.AncestorsLegacyPlayerController:ServerSendChatMessage",
            "/Script/AncestorsLegacy.AncestorsLegacyGameMode:ReceiveChatMessage",
            "/Script/AncestorsLegacy.AncestorsLegacyPlayerController:ServerSay",
            "/Script/AncestorsLegacy.AncestorsLegacyPlayerController:ClientMessage"
        },
