-- SCP: 5K profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Scp5K' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Scp5K.Scp5KGameStateInGame:BroadcastChatMessage",
            "/Script/Scp5K.Scp5KGameState:BroadcastChatMessage",
            "/Script/Scp5K.Scp5KGameState:Multicast_ChatMessage",
            "/Script/Scp5K.Scp5KPlayerController:ClientReceiveChatMessage",
            "/Script/Scp5K.Scp5KPlayerController:ServerSendChatMessage",
            "/Script/Scp5K.Scp5KGameMode:ReceiveChatMessage",
            "/Script/Scp5K.Scp5KPlayerController:ServerSay",
            "/Script/Scp5K.Scp5KPlayerController:ClientMessage"
        },
