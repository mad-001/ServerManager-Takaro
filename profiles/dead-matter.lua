-- Dead Matter profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'DeadMatter' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/DeadMatter.DeadMatterGameStateInGame:BroadcastChatMessage",
            "/Script/DeadMatter.DeadMatterGameState:BroadcastChatMessage",
            "/Script/DeadMatter.DeadMatterGameState:Multicast_ChatMessage",
            "/Script/DeadMatter.DeadMatterPlayerController:ClientReceiveChatMessage",
            "/Script/DeadMatter.DeadMatterPlayerController:ServerSendChatMessage",
            "/Script/DeadMatter.DeadMatterGameMode:ReceiveChatMessage",
            "/Script/DeadMatter.DeadMatterPlayerController:ServerSay",
            "/Script/DeadMatter.DeadMatterPlayerController:ClientMessage"
        },
