-- Operation: Harsh Doorstop profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'OperationHarshDoorstop' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/OperationHarshDoorstop.OperationHarshDoorstopGameStateInGame:BroadcastChatMessage",
            "/Script/OperationHarshDoorstop.OperationHarshDoorstopGameState:BroadcastChatMessage",
            "/Script/OperationHarshDoorstop.OperationHarshDoorstopGameState:Multicast_ChatMessage",
            "/Script/OperationHarshDoorstop.OperationHarshDoorstopPlayerController:ClientReceiveChatMessage",
            "/Script/OperationHarshDoorstop.OperationHarshDoorstopPlayerController:ServerSendChatMessage",
            "/Script/OperationHarshDoorstop.OperationHarshDoorstopGameMode:ReceiveChatMessage",
            "/Script/OperationHarshDoorstop.OperationHarshDoorstopPlayerController:ServerSay",
            "/Script/OperationHarshDoorstop.OperationHarshDoorstopPlayerController:ClientMessage"
        },
