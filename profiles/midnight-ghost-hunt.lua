-- Midnight Ghost Hunt profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'MidnightGhostHunt' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/MidnightGhostHunt.MidnightGhostHuntGameStateInGame:BroadcastChatMessage",
            "/Script/MidnightGhostHunt.MidnightGhostHuntGameState:BroadcastChatMessage",
            "/Script/MidnightGhostHunt.MidnightGhostHuntGameState:Multicast_ChatMessage",
            "/Script/MidnightGhostHunt.MidnightGhostHuntPlayerController:ClientReceiveChatMessage",
            "/Script/MidnightGhostHunt.MidnightGhostHuntPlayerController:ServerSendChatMessage",
            "/Script/MidnightGhostHunt.MidnightGhostHuntGameMode:ReceiveChatMessage",
            "/Script/MidnightGhostHunt.MidnightGhostHuntPlayerController:ServerSay",
            "/Script/MidnightGhostHunt.MidnightGhostHuntPlayerController:ClientMessage"
        },
