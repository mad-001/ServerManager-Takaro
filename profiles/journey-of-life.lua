-- Journey Of Life profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'JourneyOfLife' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/JourneyOfLife.JourneyOfLifeGameStateInGame:BroadcastChatMessage",
            "/Script/JourneyOfLife.JourneyOfLifeGameState:BroadcastChatMessage",
            "/Script/JourneyOfLife.JourneyOfLifeGameState:Multicast_ChatMessage",
            "/Script/JourneyOfLife.JourneyOfLifePlayerController:ClientReceiveChatMessage",
            "/Script/JourneyOfLife.JourneyOfLifePlayerController:ServerSendChatMessage",
            "/Script/JourneyOfLife.JourneyOfLifeGameMode:ReceiveChatMessage",
            "/Script/JourneyOfLife.JourneyOfLifePlayerController:ServerSay",
            "/Script/JourneyOfLife.JourneyOfLifePlayerController:ClientMessage"
        },
