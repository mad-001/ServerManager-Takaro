-- In The Black profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'InTheBlack' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/InTheBlack.InTheBlackGameStateInGame:BroadcastChatMessage",
            "/Script/InTheBlack.InTheBlackGameState:BroadcastChatMessage",
            "/Script/InTheBlack.InTheBlackGameState:Multicast_ChatMessage",
            "/Script/InTheBlack.InTheBlackPlayerController:ClientReceiveChatMessage",
            "/Script/InTheBlack.InTheBlackPlayerController:ServerSendChatMessage",
            "/Script/InTheBlack.InTheBlackGameMode:ReceiveChatMessage",
            "/Script/InTheBlack.InTheBlackPlayerController:ServerSay",
            "/Script/InTheBlack.InTheBlackPlayerController:ClientMessage"
        },
