-- Day of Dragons profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'DayOfDragons' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/DayOfDragons.DayOfDragonsGameStateInGame:BroadcastChatMessage",
            "/Script/DayOfDragons.DayOfDragonsGameState:BroadcastChatMessage",
            "/Script/DayOfDragons.DayOfDragonsGameState:Multicast_ChatMessage",
            "/Script/DayOfDragons.DayOfDragonsPlayerController:ClientReceiveChatMessage",
            "/Script/DayOfDragons.DayOfDragonsPlayerController:ServerSendChatMessage",
            "/Script/DayOfDragons.DayOfDragonsGameMode:ReceiveChatMessage",
            "/Script/DayOfDragons.DayOfDragonsPlayerController:ServerSay",
            "/Script/DayOfDragons.DayOfDragonsPlayerController:ClientMessage"
        },
