-- TerraTech Worlds profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'TerratechWorlds' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/TerratechWorlds.TerratechWorldsGameStateInGame:BroadcastChatMessage",
            "/Script/TerratechWorlds.TerratechWorldsGameState:BroadcastChatMessage",
            "/Script/TerratechWorlds.TerratechWorldsGameState:Multicast_ChatMessage",
            "/Script/TerratechWorlds.TerratechWorldsPlayerController:ClientReceiveChatMessage",
            "/Script/TerratechWorlds.TerratechWorldsPlayerController:ServerSendChatMessage",
            "/Script/TerratechWorlds.TerratechWorldsGameMode:ReceiveChatMessage",
            "/Script/TerratechWorlds.TerratechWorldsPlayerController:ServerSay",
            "/Script/TerratechWorlds.TerratechWorldsPlayerController:ClientMessage"
        },
