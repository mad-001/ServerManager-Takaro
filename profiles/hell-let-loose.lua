-- Hell Let Loose profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'HellLetLoose' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/HellLetLoose.HellLetLooseGameStateInGame:BroadcastChatMessage",
            "/Script/HellLetLoose.HellLetLooseGameState:BroadcastChatMessage",
            "/Script/HellLetLoose.HellLetLooseGameState:Multicast_ChatMessage",
            "/Script/HellLetLoose.HellLetLoosePlayerController:ClientReceiveChatMessage",
            "/Script/HellLetLoose.HellLetLoosePlayerController:ServerSendChatMessage",
            "/Script/HellLetLoose.HellLetLooseGameMode:ReceiveChatMessage",
            "/Script/HellLetLoose.HellLetLoosePlayerController:ServerSay",
            "/Script/HellLetLoose.HellLetLoosePlayerController:ClientMessage"
        },
