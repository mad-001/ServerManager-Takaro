-- Astroneer profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Astroneer' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Astroneer.AstroneerGameStateInGame:BroadcastChatMessage",
            "/Script/Astroneer.AstroneerGameState:BroadcastChatMessage",
            "/Script/Astroneer.AstroneerGameState:Multicast_ChatMessage",
            "/Script/Astroneer.AstroneerPlayerController:ClientReceiveChatMessage",
            "/Script/Astroneer.AstroneerPlayerController:ServerSendChatMessage",
            "/Script/Astroneer.AstroneerGameMode:ReceiveChatMessage",
            "/Script/Astroneer.AstroneerPlayerController:ServerSay",
            "/Script/Astroneer.AstroneerPlayerController:ClientMessage"
        },
