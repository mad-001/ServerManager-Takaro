-- Ultimate Arena FPS profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'UltimateArenaFps' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/UltimateArenaFps.UltimateArenaFpsGameStateInGame:BroadcastChatMessage",
            "/Script/UltimateArenaFps.UltimateArenaFpsGameState:BroadcastChatMessage",
            "/Script/UltimateArenaFps.UltimateArenaFpsGameState:Multicast_ChatMessage",
            "/Script/UltimateArenaFps.UltimateArenaFpsPlayerController:ClientReceiveChatMessage",
            "/Script/UltimateArenaFps.UltimateArenaFpsPlayerController:ServerSendChatMessage",
            "/Script/UltimateArenaFps.UltimateArenaFpsGameMode:ReceiveChatMessage",
            "/Script/UltimateArenaFps.UltimateArenaFpsPlayerController:ServerSay",
            "/Script/UltimateArenaFps.UltimateArenaFpsPlayerController:ClientMessage"
        },
