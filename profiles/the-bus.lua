-- The Bus profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'TheBus' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/TheBus.TheBusGameStateInGame:BroadcastChatMessage",
            "/Script/TheBus.TheBusGameState:BroadcastChatMessage",
            "/Script/TheBus.TheBusGameState:Multicast_ChatMessage",
            "/Script/TheBus.TheBusPlayerController:ClientReceiveChatMessage",
            "/Script/TheBus.TheBusPlayerController:ServerSendChatMessage",
            "/Script/TheBus.TheBusGameMode:ReceiveChatMessage",
            "/Script/TheBus.TheBusPlayerController:ServerSay",
            "/Script/TheBus.TheBusPlayerController:ClientMessage"
        },
