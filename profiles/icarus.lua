-- Icarus profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Icarus' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Icarus.IcarusGameStateInGame:BroadcastChatMessage",
            "/Script/Icarus.IcarusGameState:BroadcastChatMessage",
            "/Script/Icarus.IcarusGameState:Multicast_ChatMessage",
            "/Script/Icarus.IcarusPlayerController:ClientReceiveChatMessage",
            "/Script/Icarus.IcarusPlayerController:ServerSendChatMessage",
            "/Script/Icarus.IcarusGameMode:ReceiveChatMessage",
            "/Script/Icarus.IcarusPlayerController:ServerSay",
            "/Script/Icarus.IcarusPlayerController:ClientMessage"
        },
