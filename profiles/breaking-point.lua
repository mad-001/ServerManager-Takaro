-- Breaking Point profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'BreakingPoint' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/BreakingPoint.BreakingPointGameStateInGame:BroadcastChatMessage",
            "/Script/BreakingPoint.BreakingPointGameState:BroadcastChatMessage",
            "/Script/BreakingPoint.BreakingPointGameState:Multicast_ChatMessage",
            "/Script/BreakingPoint.BreakingPointPlayerController:ClientReceiveChatMessage",
            "/Script/BreakingPoint.BreakingPointPlayerController:ServerSendChatMessage",
            "/Script/BreakingPoint.BreakingPointGameMode:ReceiveChatMessage",
            "/Script/BreakingPoint.BreakingPointPlayerController:ServerSay",
            "/Script/BreakingPoint.BreakingPointPlayerController:ClientMessage"
        },
