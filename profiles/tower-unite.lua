-- Tower Unite profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'TowerUnite' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/TowerUnite.TowerUniteGameStateInGame:BroadcastChatMessage",
            "/Script/TowerUnite.TowerUniteGameState:BroadcastChatMessage",
            "/Script/TowerUnite.TowerUniteGameState:Multicast_ChatMessage",
            "/Script/TowerUnite.TowerUnitePlayerController:ClientReceiveChatMessage",
            "/Script/TowerUnite.TowerUnitePlayerController:ServerSendChatMessage",
            "/Script/TowerUnite.TowerUniteGameMode:ReceiveChatMessage",
            "/Script/TowerUnite.TowerUnitePlayerController:ServerSay",
            "/Script/TowerUnite.TowerUnitePlayerController:ClientMessage"
        },
