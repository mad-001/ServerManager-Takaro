-- Squad 44 profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Squad44' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Squad44.Squad44GameStateInGame:BroadcastChatMessage",
            "/Script/Squad44.Squad44GameState:BroadcastChatMessage",
            "/Script/Squad44.Squad44GameState:Multicast_ChatMessage",
            "/Script/Squad44.Squad44PlayerController:ClientReceiveChatMessage",
            "/Script/Squad44.Squad44PlayerController:ServerSendChatMessage",
            "/Script/Squad44.Squad44GameMode:ReceiveChatMessage",
            "/Script/Squad44.Squad44PlayerController:ServerSay",
            "/Script/Squad44.Squad44PlayerController:ClientMessage"
        },
