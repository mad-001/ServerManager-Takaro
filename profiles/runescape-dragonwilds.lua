-- RuneScape: Dragonwilds profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'RunescapeDragonwilds' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/RunescapeDragonwilds.RunescapeDragonwildsGameStateInGame:BroadcastChatMessage",
            "/Script/RunescapeDragonwilds.RunescapeDragonwildsGameState:BroadcastChatMessage",
            "/Script/RunescapeDragonwilds.RunescapeDragonwildsGameState:Multicast_ChatMessage",
            "/Script/RunescapeDragonwilds.RunescapeDragonwildsPlayerController:ClientReceiveChatMessage",
            "/Script/RunescapeDragonwilds.RunescapeDragonwildsPlayerController:ServerSendChatMessage",
            "/Script/RunescapeDragonwilds.RunescapeDragonwildsGameMode:ReceiveChatMessage",
            "/Script/RunescapeDragonwilds.RunescapeDragonwildsPlayerController:ServerSay",
            "/Script/RunescapeDragonwilds.RunescapeDragonwildsPlayerController:ClientMessage"
        },
