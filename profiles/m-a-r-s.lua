-- M.A.R.S. profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'MARS' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/MARS.MARSGameStateInGame:BroadcastChatMessage",
            "/Script/MARS.MARSGameState:BroadcastChatMessage",
            "/Script/MARS.MARSGameState:Multicast_ChatMessage",
            "/Script/MARS.MARSPlayerController:ClientReceiveChatMessage",
            "/Script/MARS.MARSPlayerController:ServerSendChatMessage",
            "/Script/MARS.MARSGameMode:ReceiveChatMessage",
            "/Script/MARS.MARSPlayerController:ServerSay",
            "/Script/MARS.MARSPlayerController:ClientMessage"
        },
