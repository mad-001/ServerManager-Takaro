-- Deadside profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Deadside' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Deadside.DeadsideGameStateInGame:BroadcastChatMessage",
            "/Script/Deadside.DeadsideGameState:BroadcastChatMessage",
            "/Script/Deadside.DeadsideGameState:Multicast_ChatMessage",
            "/Script/Deadside.DeadsidePlayerController:ClientReceiveChatMessage",
            "/Script/Deadside.DeadsidePlayerController:ServerSendChatMessage",
            "/Script/Deadside.DeadsideGameMode:ReceiveChatMessage",
            "/Script/Deadside.DeadsidePlayerController:ServerSay",
            "/Script/Deadside.DeadsidePlayerController:ClientMessage"
        },
