-- Codename CURE II profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'CodenameCureIi' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/CodenameCureIi.CodenameCureIiGameStateInGame:BroadcastChatMessage",
            "/Script/CodenameCureIi.CodenameCureIiGameState:BroadcastChatMessage",
            "/Script/CodenameCureIi.CodenameCureIiGameState:Multicast_ChatMessage",
            "/Script/CodenameCureIi.CodenameCureIiPlayerController:ClientReceiveChatMessage",
            "/Script/CodenameCureIi.CodenameCureIiPlayerController:ServerSendChatMessage",
            "/Script/CodenameCureIi.CodenameCureIiGameMode:ReceiveChatMessage",
            "/Script/CodenameCureIi.CodenameCureIiPlayerController:ServerSay",
            "/Script/CodenameCureIi.CodenameCureIiPlayerController:ClientMessage"
        },
