-- Jetball profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Jetball' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Jetball.JetballGameStateInGame:BroadcastChatMessage",
            "/Script/Jetball.JetballGameState:BroadcastChatMessage",
            "/Script/Jetball.JetballGameState:Multicast_ChatMessage",
            "/Script/Jetball.JetballPlayerController:ClientReceiveChatMessage",
            "/Script/Jetball.JetballPlayerController:ServerSendChatMessage",
            "/Script/Jetball.JetballGameMode:ReceiveChatMessage",
            "/Script/Jetball.JetballPlayerController:ServerSay",
            "/Script/Jetball.JetballPlayerController:ClientMessage"
        },
