-- Windrose profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Windrose' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Windrose.WindroseGameStateInGame:BroadcastChatMessage",
            "/Script/Windrose.WindroseGameState:BroadcastChatMessage",
            "/Script/Windrose.WindroseGameState:Multicast_ChatMessage",
            "/Script/Windrose.WindrosePlayerController:ClientReceiveChatMessage",
            "/Script/Windrose.WindrosePlayerController:ServerSendChatMessage",
            "/Script/Windrose.WindroseGameMode:ReceiveChatMessage",
            "/Script/Windrose.WindrosePlayerController:ServerSay",
            "/Script/Windrose.WindrosePlayerController:ClientMessage"
        },
