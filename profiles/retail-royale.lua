-- Retail Royale profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'RetailRoyale' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/RetailRoyale.RetailRoyaleGameStateInGame:BroadcastChatMessage",
            "/Script/RetailRoyale.RetailRoyaleGameState:BroadcastChatMessage",
            "/Script/RetailRoyale.RetailRoyaleGameState:Multicast_ChatMessage",
            "/Script/RetailRoyale.RetailRoyalePlayerController:ClientReceiveChatMessage",
            "/Script/RetailRoyale.RetailRoyalePlayerController:ServerSendChatMessage",
            "/Script/RetailRoyale.RetailRoyaleGameMode:ReceiveChatMessage",
            "/Script/RetailRoyale.RetailRoyalePlayerController:ServerSay",
            "/Script/RetailRoyale.RetailRoyalePlayerController:ClientMessage"
        },
