-- Dragons Legacy profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'DragonsLegacy' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/DragonsLegacy.DragonsLegacyGameStateInGame:BroadcastChatMessage",
            "/Script/DragonsLegacy.DragonsLegacyGameState:BroadcastChatMessage",
            "/Script/DragonsLegacy.DragonsLegacyGameState:Multicast_ChatMessage",
            "/Script/DragonsLegacy.DragonsLegacyPlayerController:ClientReceiveChatMessage",
            "/Script/DragonsLegacy.DragonsLegacyPlayerController:ServerSendChatMessage",
            "/Script/DragonsLegacy.DragonsLegacyGameMode:ReceiveChatMessage",
            "/Script/DragonsLegacy.DragonsLegacyPlayerController:ServerSay",
            "/Script/DragonsLegacy.DragonsLegacyPlayerController:ClientMessage"
        },
