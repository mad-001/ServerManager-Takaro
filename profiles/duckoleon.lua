-- Duckoleon profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Duckoleon' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Duckoleon.DuckoleonGameStateInGame:BroadcastChatMessage",
            "/Script/Duckoleon.DuckoleonGameState:BroadcastChatMessage",
            "/Script/Duckoleon.DuckoleonGameState:Multicast_ChatMessage",
            "/Script/Duckoleon.DuckoleonPlayerController:ClientReceiveChatMessage",
            "/Script/Duckoleon.DuckoleonPlayerController:ServerSendChatMessage",
            "/Script/Duckoleon.DuckoleonGameMode:ReceiveChatMessage",
            "/Script/Duckoleon.DuckoleonPlayerController:ServerSay",
            "/Script/Duckoleon.DuckoleonPlayerController:ClientMessage"
        },
