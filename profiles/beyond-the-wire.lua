-- Beyond The Wire profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'BeyondTheWire' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/BeyondTheWire.BeyondTheWireGameStateInGame:BroadcastChatMessage",
            "/Script/BeyondTheWire.BeyondTheWireGameState:BroadcastChatMessage",
            "/Script/BeyondTheWire.BeyondTheWireGameState:Multicast_ChatMessage",
            "/Script/BeyondTheWire.BeyondTheWirePlayerController:ClientReceiveChatMessage",
            "/Script/BeyondTheWire.BeyondTheWirePlayerController:ServerSendChatMessage",
            "/Script/BeyondTheWire.BeyondTheWireGameMode:ReceiveChatMessage",
            "/Script/BeyondTheWire.BeyondTheWirePlayerController:ServerSay",
            "/Script/BeyondTheWire.BeyondTheWirePlayerController:ClientMessage"
        },
