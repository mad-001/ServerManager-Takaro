-- Dragonhold profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Dragonhold' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Dragonhold.DragonholdGameStateInGame:BroadcastChatMessage",
            "/Script/Dragonhold.DragonholdGameState:BroadcastChatMessage",
            "/Script/Dragonhold.DragonholdGameState:Multicast_ChatMessage",
            "/Script/Dragonhold.DragonholdPlayerController:ClientReceiveChatMessage",
            "/Script/Dragonhold.DragonholdPlayerController:ServerSendChatMessage",
            "/Script/Dragonhold.DragonholdGameMode:ReceiveChatMessage",
            "/Script/Dragonhold.DragonholdPlayerController:ServerSay",
            "/Script/Dragonhold.DragonholdPlayerController:ClientMessage"
        },
