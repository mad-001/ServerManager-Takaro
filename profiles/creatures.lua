-- CREATURES profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Creatures' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Creatures.CreaturesGameStateInGame:BroadcastChatMessage",
            "/Script/Creatures.CreaturesGameState:BroadcastChatMessage",
            "/Script/Creatures.CreaturesGameState:Multicast_ChatMessage",
            "/Script/Creatures.CreaturesPlayerController:ClientReceiveChatMessage",
            "/Script/Creatures.CreaturesPlayerController:ServerSendChatMessage",
            "/Script/Creatures.CreaturesGameMode:ReceiveChatMessage",
            "/Script/Creatures.CreaturesPlayerController:ServerSay",
            "/Script/Creatures.CreaturesPlayerController:ClientMessage"
        },
