-- Tree of Life 2 profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'TreeOfLife2' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/TreeOfLife2.TreeOfLife2GameStateInGame:BroadcastChatMessage",
            "/Script/TreeOfLife2.TreeOfLife2GameState:BroadcastChatMessage",
            "/Script/TreeOfLife2.TreeOfLife2GameState:Multicast_ChatMessage",
            "/Script/TreeOfLife2.TreeOfLife2PlayerController:ClientReceiveChatMessage",
            "/Script/TreeOfLife2.TreeOfLife2PlayerController:ServerSendChatMessage",
            "/Script/TreeOfLife2.TreeOfLife2GameMode:ReceiveChatMessage",
            "/Script/TreeOfLife2.TreeOfLife2PlayerController:ServerSay",
            "/Script/TreeOfLife2.TreeOfLife2PlayerController:ClientMessage"
        },
