-- Spellsworn profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Spellsworn' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Spellsworn.SpellswornGameStateInGame:BroadcastChatMessage",
            "/Script/Spellsworn.SpellswornGameState:BroadcastChatMessage",
            "/Script/Spellsworn.SpellswornGameState:Multicast_ChatMessage",
            "/Script/Spellsworn.SpellswornPlayerController:ClientReceiveChatMessage",
            "/Script/Spellsworn.SpellswornPlayerController:ServerSendChatMessage",
            "/Script/Spellsworn.SpellswornGameMode:ReceiveChatMessage",
            "/Script/Spellsworn.SpellswornPlayerController:ServerSay",
            "/Script/Spellsworn.SpellswornPlayerController:ClientMessage"
        },
