-- Level Zero: Extraction profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'LevelZeroExtraction' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/LevelZeroExtraction.LevelZeroExtractionGameStateInGame:BroadcastChatMessage",
            "/Script/LevelZeroExtraction.LevelZeroExtractionGameState:BroadcastChatMessage",
            "/Script/LevelZeroExtraction.LevelZeroExtractionGameState:Multicast_ChatMessage",
            "/Script/LevelZeroExtraction.LevelZeroExtractionPlayerController:ClientReceiveChatMessage",
            "/Script/LevelZeroExtraction.LevelZeroExtractionPlayerController:ServerSendChatMessage",
            "/Script/LevelZeroExtraction.LevelZeroExtractionGameMode:ReceiveChatMessage",
            "/Script/LevelZeroExtraction.LevelZeroExtractionPlayerController:ServerSay",
            "/Script/LevelZeroExtraction.LevelZeroExtractionPlayerController:ClientMessage"
        },
