-- DeadPoly profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Deadpoly' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Deadpoly.DeadpolyGameStateInGame:BroadcastChatMessage",
            "/Script/Deadpoly.DeadpolyGameState:BroadcastChatMessage",
            "/Script/Deadpoly.DeadpolyGameState:Multicast_ChatMessage",
            "/Script/Deadpoly.DeadpolyPlayerController:ClientReceiveChatMessage",
            "/Script/Deadpoly.DeadpolyPlayerController:ServerSendChatMessage",
            "/Script/Deadpoly.DeadpolyGameMode:ReceiveChatMessage",
            "/Script/Deadpoly.DeadpolyPlayerController:ServerSay",
            "/Script/Deadpoly.DeadpolyPlayerController:ClientMessage"
        },
