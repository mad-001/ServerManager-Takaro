-- Rem Survival profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'RemSurvival' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/RemSurvival.RemSurvivalGameStateInGame:BroadcastChatMessage",
            "/Script/RemSurvival.RemSurvivalGameState:BroadcastChatMessage",
            "/Script/RemSurvival.RemSurvivalGameState:Multicast_ChatMessage",
            "/Script/RemSurvival.RemSurvivalPlayerController:ClientReceiveChatMessage",
            "/Script/RemSurvival.RemSurvivalPlayerController:ServerSendChatMessage",
            "/Script/RemSurvival.RemSurvivalGameMode:ReceiveChatMessage",
            "/Script/RemSurvival.RemSurvivalPlayerController:ServerSay",
            "/Script/RemSurvival.RemSurvivalPlayerController:ClientMessage"
        },
