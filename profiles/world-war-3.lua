-- World War 3 profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'WorldWar3' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/WorldWar3.WorldWar3GameStateInGame:BroadcastChatMessage",
            "/Script/WorldWar3.WorldWar3GameState:BroadcastChatMessage",
            "/Script/WorldWar3.WorldWar3GameState:Multicast_ChatMessage",
            "/Script/WorldWar3.WorldWar3PlayerController:ClientReceiveChatMessage",
            "/Script/WorldWar3.WorldWar3PlayerController:ServerSendChatMessage",
            "/Script/WorldWar3.WorldWar3GameMode:ReceiveChatMessage",
            "/Script/WorldWar3.WorldWar3PlayerController:ServerSay",
            "/Script/WorldWar3.WorldWar3PlayerController:ClientMessage"
        },
