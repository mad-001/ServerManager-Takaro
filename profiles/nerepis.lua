-- Nerepis profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Nerepis' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Nerepis.NerepisGameStateInGame:BroadcastChatMessage",
            "/Script/Nerepis.NerepisGameState:BroadcastChatMessage",
            "/Script/Nerepis.NerepisGameState:Multicast_ChatMessage",
            "/Script/Nerepis.NerepisPlayerController:ClientReceiveChatMessage",
            "/Script/Nerepis.NerepisPlayerController:ServerSendChatMessage",
            "/Script/Nerepis.NerepisGameMode:ReceiveChatMessage",
            "/Script/Nerepis.NerepisPlayerController:ServerSay",
            "/Script/Nerepis.NerepisPlayerController:ClientMessage"
        },
