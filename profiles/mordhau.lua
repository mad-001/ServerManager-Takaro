-- Mordhau profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Mordhau' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Mordhau.MordhauGameStateInGame:BroadcastChatMessage",
            "/Script/Mordhau.MordhauGameState:BroadcastChatMessage",
            "/Script/Mordhau.MordhauGameState:Multicast_ChatMessage",
            "/Script/Mordhau.MordhauPlayerController:ClientReceiveChatMessage",
            "/Script/Mordhau.MordhauPlayerController:ServerSendChatMessage",
            "/Script/Mordhau.MordhauGameMode:ReceiveChatMessage",
            "/Script/Mordhau.MordhauPlayerController:ServerSay",
            "/Script/Mordhau.MordhauPlayerController:ClientMessage"
        },
