-- The Isle profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'TheIsle' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/TheIsle.TheIsleGameStateInGame:BroadcastChatMessage",
            "/Script/TheIsle.TheIsleGameState:BroadcastChatMessage",
            "/Script/TheIsle.TheIsleGameState:Multicast_ChatMessage",
            "/Script/TheIsle.TheIslePlayerController:ClientReceiveChatMessage",
            "/Script/TheIsle.TheIslePlayerController:ServerSendChatMessage",
            "/Script/TheIsle.TheIsleGameMode:ReceiveChatMessage",
            "/Script/TheIsle.TheIslePlayerController:ServerSay",
            "/Script/TheIsle.TheIslePlayerController:ClientMessage"
        },
