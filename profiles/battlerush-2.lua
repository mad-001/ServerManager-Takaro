-- BattleRush 2 profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Battlerush2' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Battlerush2.Battlerush2GameStateInGame:BroadcastChatMessage",
            "/Script/Battlerush2.Battlerush2GameState:BroadcastChatMessage",
            "/Script/Battlerush2.Battlerush2GameState:Multicast_ChatMessage",
            "/Script/Battlerush2.Battlerush2PlayerController:ClientReceiveChatMessage",
            "/Script/Battlerush2.Battlerush2PlayerController:ServerSendChatMessage",
            "/Script/Battlerush2.Battlerush2GameMode:ReceiveChatMessage",
            "/Script/Battlerush2.Battlerush2PlayerController:ServerSay",
            "/Script/Battlerush2.Battlerush2PlayerController:ClientMessage"
        },
