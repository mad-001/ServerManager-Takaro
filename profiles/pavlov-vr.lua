-- Pavlov VR profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'PavlovVr' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/PavlovVr.PavlovVrGameStateInGame:BroadcastChatMessage",
            "/Script/PavlovVr.PavlovVrGameState:BroadcastChatMessage",
            "/Script/PavlovVr.PavlovVrGameState:Multicast_ChatMessage",
            "/Script/PavlovVr.PavlovVrPlayerController:ClientReceiveChatMessage",
            "/Script/PavlovVr.PavlovVrPlayerController:ServerSendChatMessage",
            "/Script/PavlovVr.PavlovVrGameMode:ReceiveChatMessage",
            "/Script/PavlovVr.PavlovVrPlayerController:ServerSay",
            "/Script/PavlovVr.PavlovVrPlayerController:ClientMessage"
        },
