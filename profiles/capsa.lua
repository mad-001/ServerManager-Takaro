-- Capsa profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Capsa' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Capsa.CapsaGameStateInGame:BroadcastChatMessage",
            "/Script/Capsa.CapsaGameState:BroadcastChatMessage",
            "/Script/Capsa.CapsaGameState:Multicast_ChatMessage",
            "/Script/Capsa.CapsaPlayerController:ClientReceiveChatMessage",
            "/Script/Capsa.CapsaPlayerController:ServerSendChatMessage",
            "/Script/Capsa.CapsaGameMode:ReceiveChatMessage",
            "/Script/Capsa.CapsaPlayerController:ServerSay",
            "/Script/Capsa.CapsaPlayerController:ClientMessage"
        },
