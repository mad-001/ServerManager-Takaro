-- Abiotic Factor profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'AbioticFactor' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/AbioticFactor.AbioticFactorGameStateInGame:BroadcastChatMessage",
            "/Script/AbioticFactor.AbioticFactorGameState:BroadcastChatMessage",
            "/Script/AbioticFactor.AbioticFactorGameState:Multicast_ChatMessage",
            "/Script/AbioticFactor.AbioticFactorPlayerController:ClientReceiveChatMessage",
            "/Script/AbioticFactor.AbioticFactorPlayerController:ServerSendChatMessage",
            "/Script/AbioticFactor.AbioticFactorGameMode:ReceiveChatMessage",
            "/Script/AbioticFactor.AbioticFactorPlayerController:ServerSay",
            "/Script/AbioticFactor.AbioticFactorPlayerController:ClientMessage"
        },
