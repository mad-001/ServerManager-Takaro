-- StickyBots profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Stickybots' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Stickybots.StickybotsGameStateInGame:BroadcastChatMessage",
            "/Script/Stickybots.StickybotsGameState:BroadcastChatMessage",
            "/Script/Stickybots.StickybotsGameState:Multicast_ChatMessage",
            "/Script/Stickybots.StickybotsPlayerController:ClientReceiveChatMessage",
            "/Script/Stickybots.StickybotsPlayerController:ServerSendChatMessage",
            "/Script/Stickybots.StickybotsGameMode:ReceiveChatMessage",
            "/Script/Stickybots.StickybotsPlayerController:ServerSay",
            "/Script/Stickybots.StickybotsPlayerController:ClientMessage"
        },
