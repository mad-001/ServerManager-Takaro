-- Beasts of Bermuda profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'BeastsOfBermuda' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/BeastsOfBermuda.BeastsOfBermudaGameStateInGame:BroadcastChatMessage",
            "/Script/BeastsOfBermuda.BeastsOfBermudaGameState:BroadcastChatMessage",
            "/Script/BeastsOfBermuda.BeastsOfBermudaGameState:Multicast_ChatMessage",
            "/Script/BeastsOfBermuda.BeastsOfBermudaPlayerController:ClientReceiveChatMessage",
            "/Script/BeastsOfBermuda.BeastsOfBermudaPlayerController:ServerSendChatMessage",
            "/Script/BeastsOfBermuda.BeastsOfBermudaGameMode:ReceiveChatMessage",
            "/Script/BeastsOfBermuda.BeastsOfBermudaPlayerController:ServerSay",
            "/Script/BeastsOfBermuda.BeastsOfBermudaPlayerController:ClientMessage"
        },
