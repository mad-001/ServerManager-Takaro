-- Ghosts of Tabor profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'GhostsOfTabor' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/GhostsOfTabor.GhostsOfTaborGameStateInGame:BroadcastChatMessage",
            "/Script/GhostsOfTabor.GhostsOfTaborGameState:BroadcastChatMessage",
            "/Script/GhostsOfTabor.GhostsOfTaborGameState:Multicast_ChatMessage",
            "/Script/GhostsOfTabor.GhostsOfTaborPlayerController:ClientReceiveChatMessage",
            "/Script/GhostsOfTabor.GhostsOfTaborPlayerController:ServerSendChatMessage",
            "/Script/GhostsOfTabor.GhostsOfTaborGameMode:ReceiveChatMessage",
            "/Script/GhostsOfTabor.GhostsOfTaborPlayerController:ServerSay",
            "/Script/GhostsOfTabor.GhostsOfTaborPlayerController:ClientMessage"
        },
