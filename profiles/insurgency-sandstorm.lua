-- Insurgency: Sandstorm profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'InsurgencySandstorm' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/InsurgencySandstorm.InsurgencySandstormGameStateInGame:BroadcastChatMessage",
            "/Script/InsurgencySandstorm.InsurgencySandstormGameState:BroadcastChatMessage",
            "/Script/InsurgencySandstorm.InsurgencySandstormGameState:Multicast_ChatMessage",
            "/Script/InsurgencySandstorm.InsurgencySandstormPlayerController:ClientReceiveChatMessage",
            "/Script/InsurgencySandstorm.InsurgencySandstormPlayerController:ServerSendChatMessage",
            "/Script/InsurgencySandstorm.InsurgencySandstormGameMode:ReceiveChatMessage",
            "/Script/InsurgencySandstorm.InsurgencySandstormPlayerController:ServerSay",
            "/Script/InsurgencySandstorm.InsurgencySandstormPlayerController:ClientMessage"
        },
