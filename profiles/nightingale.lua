-- Nightingale profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Nightingale' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Nightingale.NightingaleGameStateInGame:BroadcastChatMessage",
            "/Script/Nightingale.NightingaleGameState:BroadcastChatMessage",
            "/Script/Nightingale.NightingaleGameState:Multicast_ChatMessage",
            "/Script/Nightingale.NightingalePlayerController:ClientReceiveChatMessage",
            "/Script/Nightingale.NightingalePlayerController:ServerSendChatMessage",
            "/Script/Nightingale.NightingaleGameMode:ReceiveChatMessage",
            "/Script/Nightingale.NightingalePlayerController:ServerSay",
            "/Script/Nightingale.NightingalePlayerController:ClientMessage"
        },
