-- Squad profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'Squad' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/Squad.SquadGameStateInGame:BroadcastChatMessage",
            "/Script/Squad.SquadGameState:BroadcastChatMessage",
            "/Script/Squad.SquadGameState:Multicast_ChatMessage",
            "/Script/Squad.SquadPlayerController:ClientReceiveChatMessage",
            "/Script/Squad.SquadPlayerController:ServerSendChatMessage",
            "/Script/Squad.SquadGameMode:ReceiveChatMessage",
            "/Script/Squad.SquadPlayerController:ServerSay",
            "/Script/Squad.SquadPlayerController:ClientMessage"
        },
