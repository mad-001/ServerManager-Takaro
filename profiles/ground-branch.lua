-- Ground Branch profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'GroundBranch' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/GroundBranch.GroundBranchGameStateInGame:BroadcastChatMessage",
            "/Script/GroundBranch.GroundBranchGameState:BroadcastChatMessage",
            "/Script/GroundBranch.GroundBranchGameState:Multicast_ChatMessage",
            "/Script/GroundBranch.GroundBranchPlayerController:ClientReceiveChatMessage",
            "/Script/GroundBranch.GroundBranchPlayerController:ServerSendChatMessage",
            "/Script/GroundBranch.GroundBranchGameMode:ReceiveChatMessage",
            "/Script/GroundBranch.GroundBranchPlayerController:ServerSay",
            "/Script/GroundBranch.GroundBranchPlayerController:ClientMessage"
        },
