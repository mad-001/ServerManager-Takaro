-- Hanako: Honor & Blade profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'HanakoHonorBlade' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/HanakoHonorBlade.HanakoHonorBladeGameStateInGame:BroadcastChatMessage",
            "/Script/HanakoHonorBlade.HanakoHonorBladeGameState:BroadcastChatMessage",
            "/Script/HanakoHonorBlade.HanakoHonorBladeGameState:Multicast_ChatMessage",
            "/Script/HanakoHonorBlade.HanakoHonorBladePlayerController:ClientReceiveChatMessage",
            "/Script/HanakoHonorBlade.HanakoHonorBladePlayerController:ServerSendChatMessage",
            "/Script/HanakoHonorBlade.HanakoHonorBladeGameMode:ReceiveChatMessage",
            "/Script/HanakoHonorBlade.HanakoHonorBladePlayerController:ServerSay",
            "/Script/HanakoHonorBlade.HanakoHonorBladePlayerController:ClientMessage"
        },
