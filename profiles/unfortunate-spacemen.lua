-- Unfortunate Spacemen profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'UnfortunateSpacemen' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/UnfortunateSpacemen.UnfortunateSpacemenGameStateInGame:BroadcastChatMessage",
            "/Script/UnfortunateSpacemen.UnfortunateSpacemenGameState:BroadcastChatMessage",
            "/Script/UnfortunateSpacemen.UnfortunateSpacemenGameState:Multicast_ChatMessage",
            "/Script/UnfortunateSpacemen.UnfortunateSpacemenPlayerController:ClientReceiveChatMessage",
            "/Script/UnfortunateSpacemen.UnfortunateSpacemenPlayerController:ServerSendChatMessage",
            "/Script/UnfortunateSpacemen.UnfortunateSpacemenGameMode:ReceiveChatMessage",
            "/Script/UnfortunateSpacemen.UnfortunateSpacemenPlayerController:ServerSay",
            "/Script/UnfortunateSpacemen.UnfortunateSpacemenPlayerController:ClientMessage"
        },
