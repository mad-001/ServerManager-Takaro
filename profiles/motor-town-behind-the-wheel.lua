-- Motor Town: Behind The Wheel profile for ServerManager-Takaro
...
--   (Objects dumper) and set an explicit chat.hook. The /Script module was guessed as 'MotorTownBehindTheWheel' from the game title and is very likely wrong for chat — expect to set chat.hook after a UFunction dump.
...
return {
    ...
    chat = {
        candidates = {
            "/Script/MotorTownBehindTheWheel.MotorTownBehindTheWheelGameStateInGame:BroadcastChatMessage",
            "/Script/MotorTownBehindTheWheel.MotorTownBehindTheWheelGameState:BroadcastChatMessage",
            "/Script/MotorTownBehindTheWheel.MotorTownBehindTheWheelGameState:Multicast_ChatMessage",
            "/Script/MotorTownBehindTheWheel.MotorTownBehindTheWheelPlayerController:ClientReceiveChatMessage",
            "/Script/MotorTownBehindTheWheel.MotorTownBehindTheWheelPlayerController:ServerSendChatMessage",
            "/Script/MotorTownBehindTheWheel.MotorTownBehindTheWheelGameMode:ReceiveChatMessage",
            "/Script/MotorTownBehindTheWheel.MotorTownBehindTheWheelPlayerController:ServerSay",
            "/Script/MotorTownBehindTheWheel.MotorTownBehindTheWheelPlayerController:ClientMessage"
        },
